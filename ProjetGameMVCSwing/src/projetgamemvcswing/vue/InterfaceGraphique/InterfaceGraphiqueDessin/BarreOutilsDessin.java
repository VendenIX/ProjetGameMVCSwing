...
import projetgamemvcswing.controller.State.DessinState.MoveForm;
import projetgamemvcswing.controller.State.DessinState.DeleteForm;
import projetgamemvcswing.controller.State.DessinState.CreateLine;
import projetgamemvcswing.controller.State.DessinState.CreateCircle;
import projetgamemvcswing.controller.State.DessinState.ColorForm;
import projetgamemvcswing.controller.State.DessinState.CreateRectangle;
import javax.swing.*;
import java.awt.*;
...
public class BarreOutilsDessin extends JToolBar {
    ...
    public BarreOutilsDessin(JFrame frame, PanelDessin panelDessin) {
        ...
        undoButton.addActionListener((ActionEvent e) -> {
            ...
            panelDessin.repaint(); // Rafraîchit l'affichage
        });
